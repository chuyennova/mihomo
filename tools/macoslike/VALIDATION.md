# Kiểm tra đã thực hiện cho v3.2

- Giải nén trực tiếp `mihomo-1.19.29(9).zip`.
...
- Đối chiếu hành vi auto Flow Label của XNU: profile v3.2 dùng giá trị ngẫu nhiên 20-bit và không cưỡng chế loại bỏ giá trị 0.
